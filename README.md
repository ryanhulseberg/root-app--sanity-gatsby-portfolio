# root-app--sanity-gatsby-portfolio
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/t531m7vy/settings/api) and create a token with read rights.
